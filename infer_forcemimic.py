...
from reactive_diffusion_policy.policy.forcemimic_pt_policy import DiffusionUnetImagePolicy
...
input_key_list = ['left_robot_tcp_pose','left_robot_gripper_width', 'left_gripper1_marker_offset_emb', 'global_pts']
...
class RealWorldForceMimicInference:
...
@hydra.main(
    ...
    config_name="train_forcemimic_image_workspace"
)
def main(cfg: OmegaConf):
    ...
    inference_runner = RealWorldForceMimicInference(cfg)
