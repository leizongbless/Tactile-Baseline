...
python scripts/process_data/timer_no_lift_higher/process_data_all_zarr_any_frequency_memory_efficient.py \
    --root_path /mnt/nvme0n1p1 \
    --save_path /home/tars/projects/visual_tactile_policy/kywang/processed_pass_car_0429_30/processed_60hz \
    --task_list cxfxiaoche1_0429_30 \
    --episode_length 30 \
    --target_fps 60 \
