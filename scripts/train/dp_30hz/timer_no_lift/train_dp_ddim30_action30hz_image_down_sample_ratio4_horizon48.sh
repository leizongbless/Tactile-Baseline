...
CUDA_VISIBLE_DEVICES=2 accelerate launch train.py \
    ...
    task.dataset_path=/home/kywang/projects/efficient_robot_sys/data/ckpts/timer_no_lift_30hz/rdp_zarr \
    task.name=dp_ddim30_30hz_obs1_timer_no_lift_horizon${horizon}_30hz \
    logging.mode=online \
