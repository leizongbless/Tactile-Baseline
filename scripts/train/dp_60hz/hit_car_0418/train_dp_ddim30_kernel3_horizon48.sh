...
CUDA_VISIBLE_DEVICES=0 accelerate launch train.py \
    ...
    task.dataset_path=/mnt/data/kywang/4090_env/projects/efficient_robot_sys/data/ckpts/hit_car_0418_60hz/rdp_zarr \
    task.name=dp_ddim30_kernel${kernel_size}_hit_car_0418_60hz_horizon${horizon} \
    logging.mode=online \
    ...
    logging.id="train_hit_car_0418_dp" \
