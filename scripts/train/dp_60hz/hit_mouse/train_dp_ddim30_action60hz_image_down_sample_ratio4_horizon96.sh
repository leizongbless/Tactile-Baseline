...
CUDA_VISIBLE_DEVICES=3 accelerate launch train.py \
    ...
    task.dataset_path=/home/kywang/projects/efficient_robot_sys/data/ckpts/hit_mouse_60hz/rdp_zarr \
    task.name=dp_ddim30_60hz_obs1_hit_mouse_horizon${horizon}_60hz \
    logging.mode=online \
