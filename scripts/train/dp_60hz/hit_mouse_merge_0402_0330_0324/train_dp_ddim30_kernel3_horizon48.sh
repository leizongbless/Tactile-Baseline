...
CUDA_VISIBLE_DEVICES=0 accelerate launch train.py \
    ...
    task.dataset_path=/home/kywang/projects/efficient_robot_sys/data/ckpts/hit_mouse_merge_0402_0330_0324_60hz/rdp_zarr \
    task.name=dp_ddim30_kernel${kernel_size}_60hz_obs1_hit_mouse_merge_0402_horizon${horizon}_60hz \
    logging.mode=online \
