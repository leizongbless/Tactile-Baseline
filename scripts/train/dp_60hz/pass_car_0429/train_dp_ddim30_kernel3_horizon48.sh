...
CUDA_VISIBLE_DEVICES=0 accelerate launch train.py \
    ...
    task.dataset_path=/mnt/data/kywang/4090_env/projects/efficient_robot_sys/data/ckpts/pass_car_0429_60hz/rdp_zarr \
    task.name=dp_ddim30_kernel${kernel_size}_60hz_obs1_pass_car_0429_horizon${horizon}_60hz \
    logging.mode=online \
    ...
    logging.id="train_pass_car_0429_dp_2" \
