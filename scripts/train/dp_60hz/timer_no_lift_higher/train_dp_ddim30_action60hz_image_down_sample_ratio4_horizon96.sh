...
CUDA_VISIBLE_DEVICES=0 accelerate launch train.py \
    ...
    task.dataset_path=/home/kywang/projects/efficient_robot_sys/data/ckpts/timer_no_lift_higher_60hz/rdp_zarr \
    task.name=dp_ddim30_60hz_obs1_timer_no_lift_higher_horizon${horizon}_60hz \
    logging.mode=online \
