...
CUDA_VISIBLE_DEVICES=1 accelerate launch train.py \
    ...
    task.dataset_path=/home/kywang/projects/efficient_robot_sys/data/ckpts/write_board_60hz/rdp_zarr \
    task.name=dp_ddim30_60hz_obs1_write_board_horizon48_60hz \
    logging.mode=online \
