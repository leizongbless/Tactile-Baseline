...
DATASET_PATH="/mnt/data/kywang/4090_env/projects/efficient_robot_sys/data/ckpts/pass_car_0429_60hz/rdp_zarr"
LOGGING_MODE="online"
TIMESTAMP=pass_car_0429_ldp_horizon${horizon}
SEARCH_PATH="./data/outputs"
num_epochs=200 
kernel_size=3


AT_LOAD_DIR="/mnt/data/kywang/4090_env/projects/efficient_robot_sys/data/ckpts/pass_car_0429_60hz/ckpts_abs/rdp_vae/n_embed_10/horizon${horizon}/latest.ckpt"
