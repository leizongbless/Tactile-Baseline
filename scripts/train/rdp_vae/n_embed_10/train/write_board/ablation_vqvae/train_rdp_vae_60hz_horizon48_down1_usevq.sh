...
LOGGING_MODE="online"
TIMESTAMP=write_board_rdp_vae_60hz_horizon48_usevq_downsample${downsample}
...
# echo ${AT_LOAD_DIR}
# cp ${AT_LOAD_DIR} /home/kywang/projects/efficient_robot_sys/data/ckpts/write_board_60hz/ckpts_abs/rdp_vae/n_embed_10/horizon48/
