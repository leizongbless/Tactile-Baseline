...
CUDA_VISIBLE_DEVICES=0 accelerate launch train.py \
    ...
    task.dataset_path=/mnt/data/kywang/4090_env/projects/efficient_robot_sys/data/ckpts/flexiv_pass_car_0429_30hz/rdp_zarr \
    task.name=dp_ddim30_kernel${kernel_size}_flexiv_pass_car_0429_30hz_horizon${horizon} \
    logging.mode=online \
    ...
    logging.id="train_flexiv_pass_car_0429_dp_horizon48" \
