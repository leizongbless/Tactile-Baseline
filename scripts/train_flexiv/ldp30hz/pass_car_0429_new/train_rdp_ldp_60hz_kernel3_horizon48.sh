...
LOGGING_MODE="online"
TIMESTAMP=flexiv_pass_car_0429_new_ldp_horizon${horizon}
SEARCH_PATH="./data/outputs"
num_epochs=400 
kernel_size=3


AT_LOAD_DIR="/mnt/data/kywang/4090_env/projects/efficient_robot_sys/data/ckpts/flexiv_pass_car_0429_new_30hz/ckpts_abs/rdp_vae/n_embed_10/horizon${horizon}/latest.ckpt"
...
CUDA_VISIBLE_DEVICES=${GPU_ID} accelerate launch train.py \
    ...
    logging.id="train_flexiv_pass_car_0429_new_ldp_horizon${horizon}" \
