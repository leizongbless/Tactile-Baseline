...
TIMESTAMP=${TIMESTAMP:-"cloth0429_temporal_conv_vae_base_h128_l24_kl1e6_h${horizon}_epoch${num_epochs}"}
...
echo "Training TemporalConvVAE base_h128_l24_kl1e6 on GPU ${GPU_ID}"
